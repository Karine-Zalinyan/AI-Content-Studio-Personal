...
<div class="stock"><h2>Free Stock Video Search</h2><form id="stock-search"><label for="stock-query">Find portrait clips for Shorts or YouTube</label><input id="stock-query" type="text" placeholder="Example: aerial city at night" required><button id="stock-submit" class="secondary" type="submit">Search free stock video</button></form><div id="stock-status" class="status">Search Pexels for reusable portrait clips.</div><div id="stock-results" class="stock-results"><div class="stock-empty">No clips searched yet.</div></div></div>
...
<script>
const form=document.getElementById('create'),topic=document.getElementById('topic'),button=document.getElementById('generate'),status=document.getElementById('status'),preview=document.getElementById('preview'),exportLink=document.getElementById('export'),historyBox=document.getElementById('history'),stockForm=document.getElementById('stock-search'),stockQuery=document.getElementById('stock-query'),stockButton=document.getElementById('stock-submit'),stockStatus=document.getElementById('stock-status'),stockResults=document.getElementById('stock-results');
